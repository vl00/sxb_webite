    ...
    public static class SchUtils
    {
        ...
        static bool Can_Show2(string code, string field, int plat)
        {
            switch (field)
            {
                ...
                case "师生比":
                    {
                        //return code == "lx110" ? can_show_with_plat(true, plat, false, true)    //公办幼儿园
                        //    : code == "lx120" ? can_show_with_plat(true, plat, false, true)    //普通民办幼儿园
                        //    : code == "lx121" ? can_show_with_plat(true, plat, false, true)    //民办普惠幼儿园
                        //    : code == "lx130" ? can_show_with_plat(true, plat, false, true)    //国际幼儿园
                        //    : code == "lx199" ? can_show_with_plat(true, plat, false, true)    //幼托机构
                        //    : code == "lx210" ? can_show_with_plat(true, plat, false, true)    //公办小学
                        //    : code == "lx220" ? can_show_with_plat(true, plat, false, true)    //普通民办小学
                        //    : code == "lx231" ? can_show_with_plat(true, plat, false, true)    //双语小学
                        //    : code == "lx230" ? can_show_with_plat(true, plat, false, true)    //外国人小学
                        //    : code == "lx310" ? can_show_with_plat(true, plat, false, true)    //公办初中
                        //    : code == "lx320" ? can_show_with_plat(true, plat, false, true)    //普通民办初中
                        //    : code == "lx331" ? can_show_with_plat(true, plat, false, true)    //双语初中
                        //    : code == "lx330" ? can_show_with_plat(true, plat, false, true)    //外国人初中
                        //    : code == "lx410" ? can_show_with_plat(true, plat, false, true)    //公办高中
                        //    : code == "lx420" ? can_show_with_plat(true, plat, false, true)    //普通民办高中
                        //    : code == "lx431" ? can_show_with_plat(true, plat, false, true)    //双语高中
                        //    : code == "lx432" ? can_show_with_plat(true, plat, false, true)    //国际高中
                        //    : code == "lx430" ? can_show_with_plat(true, plat, false, true)    //外国人高中
                        //    : code == "lx180" ? can_show_with_plat(true, plat, false, true)    //港澳台幼儿园
                        //    : code == "lx280" ? can_show_with_plat(true, plat, false, true)    //港澳台小学
                        //    : code == "lx380" ? can_show_with_plat(true, plat, false, true)    //港澳台初中
                        //    : code == "lx480" ? can_show_with_plat(true, plat, false, true)    //港澳台高中
                        //    : true;
                        return false;
                    }
                case "学校认证":
