...
namespace PMS.CommentsManage.Application.IServices
{
    ...
    /// 点评审核
    /// </summary>
    public interface ISchoolCommentExaminerService : IAppService<SchoolCommentExamine>
    {
        /// <summary>
        /// 点评审核
        /// </summary>
        ...
        /// <returns></returns>
        List<SchoolCommentExamine> GetSchoolCommentByAdminId(Guid AdminId, int PageIndex, int PageSize, List<Guid> Ids, out int Total, bool IsPartTimeJob = true);
    }
}
