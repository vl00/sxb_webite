...
namespace PMS.CommentsManage.Repository.Migrations
{
    ...
    partial class CommentsManageDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PMS.CommentsManage.Domain.Entities.QuestionInfo", b =>
                {
                    ...
                    b.Property<Guid?>("UserInfoExId");

                    b.HasKey("Id");

                    b.HasIndex("UserInfoExId");
            ...
            modelBuilder.Entity("PMS.CommentsManage.Domain.Entities.UserInfoEx", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("PMS.CommentsManage.Domain.Entities.QuestionInfo", b =>
                {
                    b.HasOne("PMS.CommentsManage.Domain.Entities.UserInfoEx")
                        .WithMany("QuestionInfo")
                        .HasForeignKey("UserInfoExId");
                });
