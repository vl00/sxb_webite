...
namespace PMS.CommentsManage.Domain.IRepositories
{
    ...
    /// 答题审核
    /// </summary>
    public interface IQuestionsAnswerExamineRepository : IAppService<QuestionsAnswerExamine>
    {
        /// <summary>
        /// 问答审核
        /// </summary>
        ...
        /// <returns></returns>
        bool ExecExaminer(Guid PartTimeJobAdminId, Guid TargetId, int Status, bool IsPartTimeJob);
        /// <summary>
        /// 根据审核者id，获取该审核下的审核记录
        /// </summary>
