...
namespace ProductManagement.Framework.MongoDb
{
    ...
    public sealed class TypeUtil
    {
        ...
        public static List<Type> GetSimpleType()
        {
            ...
            TheTypes.Add(typeof(int));
            TheTypes.Add(typeof(short));
            TheTypes.Add(typeof(uint));
            TheTypes.Add(typeof(ushort));
            TheTypes.Add(typeof(long));
            TheTypes.Add(typeof(ulong));
            TheTypes.Add(typeof(byte));
            TheTypes.Add(typeof(sbyte));

            TheTypes.Add(typeof(float));
            TheTypes.Add(typeof(double));
            TheTypes.Add(typeof(decimal));

            TheTypes.Add(typeof(char));
            TheTypes.Add(typeof(string));

            TheTypes.Add(typeof(TimeSpan));
            TheTypes.Add(typeof(DateTime));

            TheTypes.Add(typeof(bool));
