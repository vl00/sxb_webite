...
{
    public class LecturesHistoryResult
    {
        public int Status { get; set; }
        public string ErrorDescription { get; set; }

        public List<LectureHItem> Items { get; set; }

        public PageinfoClass pageinfo { get; set; } 
    }


    public class LectureHItem
    {
        public LectureHHItem lectureInfo { get; set; }
